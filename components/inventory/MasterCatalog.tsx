...
import type { ChannelMapping, CompanionRecommendation, PlatformId, Product } from '@/lib/types';
...
export function MasterCatalog({
  ...
  const inventoryCompanionItems = companionRecommendations.filter((item) =>
    ['draft-po', 'reallocate-stock', 'release-reservation', 'liquidate-deadstock'].includes(item.actionType)
  );
  ...
  return (
    <div className="px-4 sm:px-8 py-6">
      ...
      <div className="mb-4">
        <CompanionPanel
          title="Inventory companion"
          subtitle="Stockout, reservation, and channel mismatch actions ready for seller approval."
          recommendations={inventoryCompanionItems}
